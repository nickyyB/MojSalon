                ...
                <div class="col-lg-12">
                    ...
                    <div style="overflow:hidden">
                        <div class="col-lg-6" style="float:left">
                            <div class = "row"> <h5>Radno vreme:</h5> </div>
                            <div class = "row"> <h7>Ponedeljak: <?php if(is_null($workingHrs->pon)) echo "Neradan dan"; echo $workingHrs->pon?></h7> </div>
                            <div class = "row"> <h7>Utorak: <?php if(is_null($workingHrs->uto)) echo "Neradan dan"; echo $workingHrs->uto ?> </h7> </div>
                            <div class = "row"> <h7>Sreda: <?php if(is_null($workingHrs->sre)) echo "Neradan dan"; echo $workingHrs->sre ?> </h7> </div>
                            <div class = "row"> <h7>Četvrtak: <?php if(is_null($workingHrs->cet)) echo "Neradan dan"; echo $workingHrs->cet ?> </h7></div>
                            <div class = "row"> <h7>Petak: <?php if(is_null($workingHrs->pet)) echo "Neradan dan"; echo $workingHrs->pet ?> </h7> </div>
                            <div class = "row"> <h7>Subota: <?php if(is_null($workingHrs->sub)) echo "Neradan dan"; echo $workingHrs->sub ?> </h7> </div>
                            <div class = "row"> <h7>Nedelja: <?php if(is_null($workingHrs->ned)) echo "Neradan dan"; echo $workingHrs->ned ?> </h7> </div>
                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="right-image">
                                            ...
                                            <button disabled style="font-size: 13px;
                                                ...
                                                transition: all .3s;" 
                                                title="Samo prijavljeni korisnici mogu da zakažu termin.">
                                                ZAKAŽI
                                            </button>      
                                        </div>
                                    </div>
