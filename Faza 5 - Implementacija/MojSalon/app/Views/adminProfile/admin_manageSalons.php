            ...
            <div class="col-lg-9 center" style="z-index: 2">
                <div class="header-text">
                    <div class="form-group">
                        <form method='GET' action="<?= site_url('Admin/salons') ?>">
                ...
                <div class="filter col-md-12">
                    <div class="row">
                        <?php if(empty($salons))
                            echo "Trenutno nema aktivnih salona." ?>
                        <ul class="nacc">
                            <?php foreach($salons as $salon): ?>
                                <li class="active">
                                    <div>
                                        <form method="POST" action="<?= site_url('Admin/removesalon') ?>">
                                        ...
                                        <button type="submit" formaction="<?= site_url('Admin/blocksalon') ?>"style="font-size: 13px;
                                            color: #fff;
                                            background: #850049;
                                            background: linear-gradient(-145deg, #850049 0%, #e30425 100%);
                                            padding: 12px 30px;
                                            ...
                                            font-weight: 500;
                                            text-transform: uppercase;
                                            transition: all .3s;">Blokiraj salon
                                        </button>
                                        </form>
                                    </div>
                                </li>
