            ...
            <div class="col-lg-9 center" style="z-index: 2">
                <div class="header-text">
                    <div class="form-group">
                        <form method='GET' action="<?= site_url('Admin/searchBlockedUsers') ?>">
                ...
                <div class="filter col-md-12">
                    <div class="row">
                        <?php if(empty($users))
                            echo "Trenutno nema blokiranih korisnika." ?>
                        <ul class="nacc">
                            <?php foreach($users as $user): ?>
                                <li class="active">
                                    <div>
                                        <form method="POST" action="<?= site_url('Admin/removeBlocked') ?>">
                                        ...
                                        <button type="submit" formaction="<?= site_url('Admin/unblock') ?>"style="font-size: 13px;
                                            color: #fff;
                                            background: #850049;
                                            background: linear-gradient(-145deg, #850049 0%, #e30425 100%);
                                            padding: 12px 30px;
                                            ...
                                            font-weight: 500;
                                            text-transform: uppercase;
                                            transition: all .3s;">Odblokiraj korisnika
                                        </button>
                                        </form>
                                    </div>
                                </li>
